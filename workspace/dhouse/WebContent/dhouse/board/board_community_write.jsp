...
<head>
    ...
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/images/2302262-logo.png">
</head>
                  ...
                  <!-- 본문 -->
                        <div class="HeaderLayout_container__3fXkO">
                            <div class="HeaderLayout_contents__F4hlC">
                                <h2 class="FundingStoryContainer_title__1r0ZE">가전제품 기부하기
                                    <button id="bottom-button"> <!-- 제출하기 버튼 -->
