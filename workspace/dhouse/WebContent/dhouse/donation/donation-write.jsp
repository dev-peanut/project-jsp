	...
	<div id="root">
		<div id="AppLayout_Container">
			<div class="total_main">
				...
				<!-- 사이드바 끝 -->
                <!-- 본문 시작  -->
                <form action="${pageContext.request.contextPath}/donation/writeOk.donation" name="donationWriteForm" method="post" enctype="multipart/form-data">
			                        ...
			                        <section class="form_section">
			                            <div style="max-width: 600px;">
			                                <div class="form_container">
			                                    <h2 class="Section_title">글 제목</h2>
			                                    ...
			                                    <div class="textarea_field">
			                                        <div class="textarea_field_form">
			                                            ...
			                                            <div class="wide_column_2">
			                                                <div class="wz input">
			                                                    <textarea placeholder="글 제목" helper="[object Object]" name="donationBoardTitle" rows="2" class="titleData"></textarea>
			                                    ...
			                                    <div class="Section_content">
			                                        <div class="textarea_field">
			                                            <div class="textarea_field_form">
			                                                ...
			                                                <div class="wide_column_2">
			                                                    <div class="wz input">
			                                                        <textarea placeholder="글 내용" helper="[object Object]" name="donationBoardContents" rows="3" class="contentData"></textarea>
