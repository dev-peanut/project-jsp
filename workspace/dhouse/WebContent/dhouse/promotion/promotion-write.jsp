...
<link rel="stylesheet"
	href="../../assets/css/promotion/promotion-write.css">
...
<body class="ReactModal__Body--open" aria-hidden="true">
	...
	<!-- <jsp:include page="../components/header.jsp"></jsp:include> -->
	<jsp:include
		page="${pageContext.request.contextPath}/dhouse/components/header.jsp"></jsp:include>
	<div class="body1" data-react-modal-body-trap="" tabindex="0"
							...
							<div class="AppLayout_main__14bCi">
								...
								<div class="AppSidebarLayout_contents__2thGr" id="sidebar">
									<div
										...
										<div
											class="AppSidebarRewardProjectInfo_projectFlagGroup__2GdB4">
										...
										<button
											...
											type="button">
											<span><span class="Button_children__q9VCZ">프로젝트
													번호 191893</span> <svg viewBox="0 0 32 32" focusable="false"
													role="presentation"
								...
								<div id="AppLayout_Contents" class="AppLayout_contents__wv3DF">
									...
									<section class="Section_container__3md8M">
										<div style="max-width: 600px;">
											<div class="Section_header__1qwS7">
												<h2 class="Section_title__ikPIm_Section_isRequired__F8rij">글
													제목</h2>
											...
											<div class="Section_content__3OkLZ">
												<div class="StorySummaryField_container__25ePA">
													<div
														class="field_Form_field__35I9T_FormFieldTextarea_field__33Ncu">
									...
									<!-- 글 내용 전체 시작 -->
									<section
										class="Section_container__3md8M_StoryEditorWrapperItemWeb_container__3bMs8"
											...
											<div class="Section_guide__2xeJO">
												<div class="Section_helperMessage__3V6GQ">
													<a class="link spacing-3 is-horizontal"
														href="https://www.wadiz.kr/link/funding_story_guide1"
														target="_blank" rel="nofollow noopener noreferrer"
														data-ga-category="펀딩_스토리_가이드" data-ga-action="클릭">펀딩
														스토리 작성 가이드 <svg viewBox="0 0 40 40" focusable="false"
															role="presentation"
                                                    ...
                                                    <path
														...
														href="https://www.wadiz.kr/link/preorder_story_guide"
														target="_blank" rel="nofollow noopener noreferrer"
														data-ga-category="프리오더_스토리_가이드" data-ga-action="클릭">프리오더
														스토리 작성 가이드 <svg viewBox="0 0 40 40" focusable="false"
															role="presentation"
										...
										<div class="Section_content__3OkLZ">
											<div color="basic"
												...
												<span> <svg viewBox="0 0 40 40" focusable="false"
														role="presentation"
														class="withIcon_icon__1Oal1_MessageBox_icon__31KWI"
														aria-hidden="true">
                                                <path fill="none"
												...
												<div class="MessageBox_description__1bCQv">
													<ul>
														<li class="imagenotice">올바른 게시판 문화를 위해 욕설, 반말은
															삼가해주세요.</li>
														<li class="imagenotice">정확한 정보 전달을 위해 제품의 상태를 상세히
															기재해주세요.</li>
												...
												<div class="Section_content__3OkLZ">
													<div class="StorySummaryField_container__25ePA">
														<div
															...
															<div class="wide_column-4">
																<div class="wz input">
																	<textarea placeholder="내용" helper="[object Object]"
																		name="storyInfo.coreMessage" rows="3"
																		class="contentData"></textarea>
																</div>
										...
										<form
											...
											<section class="Section_container__3md8M">
												<div style="max-width: 600px;">
													<div class="Section_header__1qwS7">
														<h2 class="Section_title__ikPIm_Section_isRequired__F8rij">사진
															등록</h2>
														<div class="Section_guide__2xeJO"></div>
													</div>
													<div class="Section_description__10Uwo">기부하실 음식의 사진을
														등록해주세요.</div>
													<div class="Section_content__3OkLZ">
															...
															<div
																...
																<div class="ImageFormField_buttonWrapper__su3pO">
																	<label
																		...
																		<div
																			class="wz_input_right_ImageFileButton_input__1Dnch">
																			<input type="file" id="image" accept="image/*"
																				onchange="setThumbnail(event);" />
																		</div>
																	</label> <em class="helper error"></em><em
																		class="helper_ImageFormField_helper__3XC5c">2MB
																		이하의 JPG, JPEG, GIF, PNG 파일</em>
	...
	<!-- <jsp:include page="../components/footer.jsp"></jsp:include> -->
	<jsp:include
		page="${pageContext.request.contextPath}/dhouse/components/footer.jsp"></jsp:include>
</body>
<script type="text/javascript"
	src="../../assets/js/board/board_community_write.js"></script>
</html>