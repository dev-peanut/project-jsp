...
public class MyPageCorpVO {
	...
	public String toString() {
		return "MyPageCorpVO [memberId=" + memberId + ", userIdentification=" + userIdentification + ", userPassword="
				+ userPassword + ", userName=" + userName + ", userNickname=" + userNickname + ", userPhone="
				+ userPhone + ", userEmail=" + userEmail + ", bannerId=" + bannerId + ", bannerPaymentStatus="
				+ bannerPaymentStatus + ", bannerPeriod=" + bannerPeriod + ", bannerStartDate=" + bannerStartDate
