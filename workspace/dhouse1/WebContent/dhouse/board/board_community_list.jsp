...
<link href="https://fonts.googleapis.com/css2?family=Gugi&display=swap"
   rel="stylesheet">
<link rel="shortcut icon" href="${pageContext.request.contextPath}/images/2302261-logo.png">
</head>
<body>
   <div id="page-container">
                        ...
                        <ul>
                           <li>
                              <div class="wcommunity-story">
                                 ...
                                 <div class="img-wrap">
                                    <div class="story-img"
                                       style="background-image: url(${pageContext.request.contextPath}/images/user/notebook.jpg)"></div>
                                 </div>
                              </div>
                           </li>
                           <li>
                              <div class="wcommunity-story">
                                 ...
                                 <div class="img-wrap">
                                    <div class="story-img"
                                       style="background-image: url(${pageContext.request.contextPath}/images/user/refrigerator.jpg)"></div>
                                 </div>
                              </div>
                           </li>
                           <li>
      ...
      <!-- newContainer -->
      <!-- 푸터 -->
<jsp:include page="${pageContext.request.contextPath}/dhouse/components/footer.jsp"></jsp:include>   </div>
</body>
</html>