					...
					<div class="wcommunity-content-wrap">
						<div class="wcommunity-section1"> <!-- 게시글 리스트 전체  -->
							...
							<div class="wcommunity-webzine-list"> 
								<ul>
									<li><a href="javascript:detail(8241)">
											<div class="wcommunity-story">
												...
												<div class="img-wrap">
													<div class="story-img" style="background-image: url(../../assets/img/refrigerator.jpg)"></div>
												</div>  
											</div>
									</a></li>

									<li> <a href="javascript:detail(8234)">
											<div class="wcommunity-story">
												<div class="story-info">
												...
												<div class="img-wrap">
													<div class="story-img" style="background-image: url(../../assets/img/notebook.jpg)"></div>
												</div>
											</div>
									</a></li>

									<li><a href="javascript:detail(8231)">
											<div class="wcommunity-story">
												<div class="story-info">
													<p class="title">노트북, 마우스, 헤드폰 기부합니다</p>
													<p class="summary">새 제품을 선물받아 기부합니다. 역삼역 3번 출구로 오실 분</p>
									...
									<li><a href="javascript:detail(8157)">
											<div class="wcommunity-story">
												<div class="story-info">
													<p class="title">노트북, 마우스, 헤드폰 기부합니다</p>
													<p class="summary">새 제품을 선물받아 기부합니다. 역삼역 3번 출구로 오실 분</p>
									...
									<li><a href="javascript:detail(8144)">
											<div class="wcommunity-story">
												<div class="story-info">
													<p class="title">노트북, 마우스, 헤드폰 기부합니다</p>
													<p class="summary">새 제품을 선물받아 기부합니다. 역삼역 3번 출구로 오실 분</p>
									...
									<li><a href="javascript:detail(8142)"> 
											<div class="wcommunity-story">
												<div class="story-info">
													<p class="title">노트북, 마우스, 헤드폰 기부합니다</p>
													<p class="summary">새 제품을 선물받아 기부합니다. 역삼역 3번 출구로 오실 분</p>
									...
									<li> <a href="javascript:detail(8136)"> 
											<div class="wcommunity-story">
												<div class="story-info">
									...
									<li><a href="javascript:detail(8078)">
											<div class="wcommunity-story">
												<div class="story-info">
	    				...
	    				<div class="wcommunity-bottom-util">
	    					<div class="search-story">
	    						<select id="searchSelectInBoard" class="select-list">
	    							<option value="tc">제목+내용</option>
	    							<option value="t">제목</option>
	    							<option value="c">내용</option>
	    							<option value="u">작성자</option>
	    							<option value="ht">태그</option>
	    						</select>
	    						<div class="wcommunity-search-area">
		    						<input type="text" id="searchTextInBoard" name="searchTextInBoard" value="" placeholder="펀딩 검색">
		    						<button type="button" class="btn-search" onclick="searchInBoard()"></button>
		    					</div>
	    					</div>
	    				</div> -->
							<!-- //wcommunity-bottom-util -->
							...
							<div class="inner-wrap">
								...
								<div class="wcommunity-best-list"> <!-- 랭킹 시작 -->
									...
									<ol>
										<li><em>1</em>
										<p class="title">
												<a href="javascript:detail(6547)">[이것만 보세요] 리워드 메이커를 위한 꿀팁 모음</a>
											</p></li>
										<li><em>2</em>
										<p class="title">
												<a href="javascript:detail(6627)">[에디터와 함께써요] 리워드 펀딩 스토리, 더 쉽게 쓰세요 #INTRO</a>
											</p></li>
										<li><em>3</em>
										<p class="title">
												<a href="javascript:detail(6570)">[리워드 비주얼 공략집 #2] 스토리 편집기 완전정복!</a>
											</p></li>
										<li><em>4</em>
										<p class="title">
												<a href="javascript:detail(7460)">[꿀팁모음] 캐스트 숨바꼭질은 그만! 프로젝트 오픈부터 배송까지 한 장으로 모아 보세요</a>
											</p></li>
										<li><em>5</em>
										<p class="title">
												<a href="javascript:detail(6848)">[조.스.바] 조금만 스토리를 바꿀 수 있는 &lt;비주얼 캐스트 모음&gt;</a>
											</p></li>
									</ol>
								</div> <!-- 랭킹 끝 -->
								<div class="btn-wrap">
