                       ...
                       <div class="input-btn-wrap">
                          ...
                          <p id="sendEmailInfo" class="info-text emailMsg">인증메일이 발송되었습니다.</p>
                            ...
                            <p>카카오를 연동하시면 피드에서 친구의 활동을 확인할 수 있어요</p>
	                            <ul>
									<li class="facebook"><a href="#" id="facebookLink" class="unlinked"><i class="wadizicon wa-facebook"></i></a></li>
									<li class="naver"><a href="#" id="naverLink" class="unlinked"><i class="wadizicon wa-naver"></i></a></li>
									<li class="kakao "><a href="#" id="kakaoLink" class="unlinked"><i class="wadizicon wa-kakao"></i></a></li>
									<li class="google"><a href="#" id="googleLink"><i></i></a></li>
	                            </ul>
	                        </div>
